   ...
   {  def processSubmission() = 
      ...
      */
      ...
      var boundForm = bind( "form", ns, 
            "translation" -> SHtml.textarea(if(AUTOTRANSLATION && sesCoordLR.cc.textCTLbyPlayer.equals("")) testExampleTextCTL else sesCoordLR.cc.textCTLbyPlayer, processTranslationTA, ( List("rows" -> "10", "style" -> "width: 100%") ++ editableAttrib ):_*), // todo: how to make text area page width?
